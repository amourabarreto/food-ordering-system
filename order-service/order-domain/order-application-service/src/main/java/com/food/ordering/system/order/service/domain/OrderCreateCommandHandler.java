...
import com.food.ordering.system.order.service.domain.ports.output.respository.RestaurantRespository;
...
public class OrderCreateCommandHandler {
    ...
    private Restaurant checkRestaurant(CreateOrderCommand createOrderCommand) {
        ...
        Optional<Restaurant> optionalRestaurant = restaurantRespository.findRestaurantInformation(restaurant);
