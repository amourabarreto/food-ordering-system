   ...
   public Restaurant createOrderCommandRestaurant(CreateOrderCommand createOrderCommand){
    ...
    public Order createOrderCommandToOrder(CreateOrderCommand createOrderCommand){
        return Order.builder().customerId(new CustomerId(createOrderCommand.getCustomerId()))
                ...
                .items(ordemItemsToOrderItemEntities(createOrderCommand.getItems()))
                .build();
    }

    private List<OrderItem> ordemItemsToOrderItemEntities(List<com.food.ordering.system.order.service.domain.dto.create.OrderItem> items) {
